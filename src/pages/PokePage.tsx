...
<div className="flex flex-col">
    <div className="flex items-center justify-center bg-stone-50 dark:bg-slate-900">
        <div className="p-8 border-gray-300 dark:border-slate-600 border-2 w-[60rem] dark:bg-gray-800 bg-gray-100 rounded-lg">
